            ...
            Row(children: [
              Expanded(child: Column(
                ...
                children: [
                  ...
                  Text('${tipos.length} tipos documentales · ${tipos.fold(0, (s, td) => s + td.campos.length)} campos definidos',
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('Tipos documentales', style: AppTheme.h3(t)),
                          ),
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(children: [
                                  ...
                                  FilledButton.icon(
                                    onPressed: () => _showSnack('Agregar campo a: ${sel.nombre}'),
                                ...
                                Row(children: [
                                  _badge('${sel.campos.length} campos', t.primary, t),
                          ...
                          Container(
                            ...
                            child: Row(children: [
                              SizedBox(width: 180, child: Text('Campo', style: AppTheme.tableHeader(t))),
                              SizedBox(width: 110, child: Text('Tipo', style: AppTheme.tableHeader(t))),
                              SizedBox(width: 90, child: Text('Obligatorio', style: AppTheme.tableHeader(t))),
                              const Expanded(child: Text('')),
                              SizedBox(width: 80, child: Text('Acciones', style: AppTheme.tableHeader(t))),
                            ]),
                          ),
                          Divider(color: t.border, height: 1),
                                  ...
                                  child: Row(children: [
                                    SizedBox(
                                      ...
                                      child: Row(children: [
                                        ...
                                        const SizedBox(width: 8),
                                        Expanded(child: Text(campo.nombre,
                                            style: AppTheme.tableData(t).copyWith(fontWeight: FontWeight.w500),
                                            overflow: TextOverflow.ellipsis)),
                                      ]),
                                    ),
                                    SizedBox(
                                    ...
                                    SizedBox(
                                      ...
                                      child: campo.obligatorio
                                          ? Row(children: [
                                              ...
                                              Text('Sí', style: AppTheme.tableData(t).copyWith(color: t.error)),
                                            ])
                                          : Text('No', style: AppTheme.tableData(t).copyWith(color: t.textSecondary)),
                                    ),
                                    const Spacer(),
                                    SizedBox(
                                      width: 80,
                                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                                        _iconBtn(Icons.edit_outlined, t.info,
                                            () => _showSnack('Editar campo: ${campo.nombre}')),
                                        const SizedBox(width: 4),
                                        _iconBtn(Icons.delete_outline, t.error,
                                            () => _showSnack('Eliminar campo: ${campo.nombre}')),
                                      ]),
                                    ),
                                  ]),
                                );
